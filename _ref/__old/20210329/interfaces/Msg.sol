...
interface IMsg {
    ...
    function sendWithKeypair(uint32 answerId, XCell message, uint256 pub, uint256 sec) external;
...
library Msg {
	...
	function sendWithKeypair(uint32 answerId, XCell message, uint256 pub, uint256 sec) public pure {
