...
public:
  ...
  address deployWallet(
    ...
    dest_handle.deploy(wallet_init, Crystals(crystals.get())).
      accept(tokens, answer_addr, crystals);
  ...
  void grant(
    ...
    ITONTokenWalletPtr dest_handle(dest);
    dest_handle(Crystals(crystals.get()), msg_flags).accept(tokens, answer_addr, uint128(0));
