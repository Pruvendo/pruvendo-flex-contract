...
(* 4 *) Definition TickTock_get (f: TickTockFields )(r: TickTock ) :  TickTock_field_type f := 
 match f with | TickTock_ι_tick => fst1 r 
...
(v: TickTock_field_type f) (r: TickTock ): TickTock  :=
  match f, v with | TickTock_ι_tick , v' => ( v' , snd r ) 
...
(* Definition  PriceXchg_ι_minor_tip3cfg_TonsConfig  :
 PruvendoRecord (field_type (R:=PriceXchg) 
                 PriceXchg_ι_minor_tip3cfg_ ) TonsConfigFields := 
  TonsConfig_PruvendoRecord.

Existing Instance PriceXchg_ι_minor_tip3cfg_TonsConfig.
Existing Instance Ledger_PruvendoRecord. 

Definition  PriceXchg_ι_major_tip3cfg_TonsConfig  :
 PruvendoRecord (field_type (R:=PriceXchg) 
                 PriceXchg_ι_major_tip3cfg_ ) TonsConfigFields := 
  TonsConfig_PruvendoRecord.
Existing Instance PriceXchg_ι_major_tip3cfg_TonsConfig.*)
Existing Instance Ledger_PruvendoRecord.  
