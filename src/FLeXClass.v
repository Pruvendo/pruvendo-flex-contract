 ...
 Module LedgerFLeXClass (xt: XTypesSig) (sm: StateMonadSig) <: ClassSigTVM xt sm. 
...
match f with 
 | Ledger_ι_FLeX => Flex | Ledger_ι_VMState => VMStateLRecord | Ledger_ι_LocalState => LocalState | Ledger_ι_LocalStateCopy => LocalState end .
