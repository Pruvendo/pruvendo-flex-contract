...
Notation " 'DTONTokenWallet.name_' " := ( ULState (U:= DTONTokenWallet ) DTONTokenWallet_ι_name_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.symbol_' " := ( ULState (U:= DTONTokenWallet ) DTONTokenWallet_ι_symbol_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.decimals_' " := ( ULState (U:= DTONTokenWallet ) DTONTokenWallet_ι_decimals_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.balance_' " := ( ULState (U:= DTONTokenWallet ) DTONTokenWallet_ι_balance_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.root_public_key_' " := ( ULState (U:= DTONTokenWallet ) DTONTokenWallet_ι_root_public_key_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.wallet_public_key_' " := ( ULState (U:= DTONTokenWallet ) DTONTokenWallet_ι_wallet_public_key_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.root_address_' " := ( ULState (U:= DTONTokenWallet ) DTONTokenWallet_ι_root_address_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.owner_address_' " := ( ULState (U:= DTONTokenWallet ) DTONTokenWallet_ι_owner_address_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.code_' " := ( ULState (U:= DTONTokenWallet ) DTONTokenWallet_ι_code_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.allowance_' " := ( ULState (U:= DTONTokenWallet ) DTONTokenWallet_ι_allowance_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.workchain_id_' " := ( ULState (U:= DTONTokenWallet ) DTONTokenWallet_ι_workchain_id_ ) (in custom ULValue at level 0) : ursus_scope. 
...
Notation " 'FLeXSellArgsAddrs.my_tip3_addr' " := ( ULState (U:= FLeXSellArgsAddrs ) FLeXSellArgsAddrs_ι_my_tip3_addr ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'FLeXSellArgsAddrs.receive_wallet' " := ( ULState (U:= FLeXSellArgsAddrs ) FLeXSellArgsAddrs_ι_receive_wallet ) (in custom ULValue at level 0) : ursus_scope. 
...
Notation " 'DetailsInfoXchg.price_num' " := ( ULState (U:= DetailsInfoXchg ) DetailsInfoXchg_ι_price_num ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DetailsInfoXchg.price_denum' " := ( ULState (U:= DetailsInfoXchg ) DetailsInfoXchg_ι_price_denum ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DetailsInfoXchg.min_amount' " := ( ULState (U:= DetailsInfoXchg ) DetailsInfoXchg_ι_min_amount ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DetailsInfoXchg.sell_amount' " := ( ULState (U:= DetailsInfoXchg ) DetailsInfoXchg_ι_sell_amount ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DetailsInfoXchg.buy_amount' " := ( ULState (U:= DetailsInfoXchg ) DetailsInfoXchg_ι_buy_amount ) (in custom ULValue at level 0) : ursus_scope. 
...
Notation " 'DTradingPair.flex_addr_' " := ( ULState (U:= DTradingPair ) DTradingPair_ι_flex_addr_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DTradingPair.tip3_root_' " := ( ULState (U:= DTradingPair ) DTradingPair_ι_tip3_root_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DTradingPair.deploy_value_' " := ( ULState (U:= DTradingPair ) DTradingPair_ι_deploy_value_ ) (in custom ULValue at level 0) : ursus_scope. 

Notation " 'DXchgPair.flex_addr_' " := ( ULState (U:= DXchgPair ) DXchgPair_ι_flex_addr_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DXchgPair.tip3_major_root_' " := ( ULState (U:= DXchgPair ) DXchgPair_ι_tip3_major_root_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DXchgPair.tip3_minor_root_' " := ( ULState (U:= DXchgPair ) DXchgPair_ι_tip3_minor_root_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'DXchgPair.deploy_value_' " := ( ULState (U:= DXchgPair ) DXchgPair_ι_deploy_value_ ) (in custom ULValue at level 0) : ursus_scope. 
...
Notation " 'LocalState.uint256' " := ( ULState (U:= LocalState ) LocalState_ι_uint256 ) (in custom ULValue at level 0) : ursus_scope. 
 ...
 Notation " 'LocalState.DTradingPair' " := ( ULState (U:= LocalState ) LocalState_ι_DTradingPair ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_ITradingPair_' " := ( ULState (U:= LocalState ) LocalState_ι_handle_ITradingPair_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.DXchgPair' " := ( ULState (U:= LocalState ) LocalState_ι_DXchgPair ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_IXchgPair_' " := ( ULState (U:= LocalState ) LocalState_ι_handle_IXchgPair_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXSellArgs_' " := ( ULState (U:= LocalState ) LocalState_ι_parse_FLeXSellArgs_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_IPrice_' " := ( ULState (U:= LocalState ) LocalState_ι_handle_IPrice_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.SellArgs' " := ( ULState (U:= LocalState ) LocalState_ι_SellArgs ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXBuyArgs_' " := ( ULState (U:= LocalState ) LocalState_ι_parse_FLeXBuyArgs_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXCancelArgs_' " := ( ULState (U:= LocalState ) LocalState_ι_parse_FLeXCancelArgs_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXXchgCancelArgs_' " := ( ULState (U:= LocalState ) LocalState_ι_parse_FLeXXchgCancelArgs_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_IPriceXchg_' " := ( ULState (U:= LocalState ) LocalState_ι_handle_IPriceXchg_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.bool_t' " := ( ULState (U:= LocalState ) LocalState_ι_bool_t ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXXchgArgs_' " := ( ULState (U:= LocalState ) LocalState_ι_parse_FLeXXchgArgs_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.PayloadArgs' " := ( ULState (U:= LocalState ) LocalState_ι_PayloadArgs ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_ITONTokenWallet_' " := ( ULState (U:= LocalState ) LocalState_ι_handle_ITONTokenWallet_ ) (in custom ULValue at level 0) : ursus_scope. 
 ...
 Notation " 'LocalState.DPrice' " := ( ULState (U:= LocalState ) LocalState_ι_DPrice ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.DPriceXchg' " := ( ULState (U:= LocalState ) LocalState_ι_DPriceXchg ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.tuple_address_address' " := ( ULState (U:= LocalState ) LocalState_ι_tuple_address_address ) (in custom ULValue at level 0) : ursus_scope. 
 ...
 Notation " 'LocalState.optional_uint128_' " := ( ULState (U:= LocalState ) LocalState_ι_optional_uint128_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.bool' " := ( ULState (U:= LocalState ) LocalState_ι_bool ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.optional_OrderInfoWithIdx_' " := ( ULState (U:= LocalState ) LocalState_ι_optional_OrderInfoWithIdx_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.queue_OrderInfo_' " := ( ULState (U:= LocalState ) LocalState_ι_queue_OrderInfo_ ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.pair_unsigned_OrderInfo_' " := ( ULState (U:= LocalState ) LocalState_ι_pair_unsigned_OrderInfo_ ) (in custom ULValue at level 0) : ursus_scope. 
...
Notation " 'DTONTokenWallet.name_' " := ( URState (U:= DTONTokenWallet ) DTONTokenWallet_ι_name_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.symbol_' " := ( URState (U:= DTONTokenWallet ) DTONTokenWallet_ι_symbol_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.decimals_' " := ( URState (U:= DTONTokenWallet ) DTONTokenWallet_ι_decimals_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.balance_' " := ( URState (U:= DTONTokenWallet ) DTONTokenWallet_ι_balance_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.root_public_key_' " := ( URState (U:= DTONTokenWallet ) DTONTokenWallet_ι_root_public_key_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.wallet_public_key_' " := ( URState (U:= DTONTokenWallet ) DTONTokenWallet_ι_wallet_public_key_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.root_address_' " := ( URState (U:= DTONTokenWallet ) DTONTokenWallet_ι_root_address_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.owner_address_' " := ( URState (U:= DTONTokenWallet ) DTONTokenWallet_ι_owner_address_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.code_' " := ( URState (U:= DTONTokenWallet ) DTONTokenWallet_ι_code_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.allowance_' " := ( URState (U:= DTONTokenWallet ) DTONTokenWallet_ι_allowance_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DTONTokenWallet.workchain_id_' " := ( URState (U:= DTONTokenWallet ) DTONTokenWallet_ι_workchain_id_ ) (in custom URValue at level 0) : ursus_scope. 
...
Notation " 'FLeXSellArgsAddrs.my_tip3_addr' " := ( URState (U:= FLeXSellArgsAddrs ) FLeXSellArgsAddrs_ι_my_tip3_addr ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'FLeXSellArgsAddrs.receive_wallet' " := ( URState (U:= FLeXSellArgsAddrs ) FLeXSellArgsAddrs_ι_receive_wallet ) (in custom URValue at level 0) : ursus_scope. 
...
Notation " 'DetailsInfoXchg.price_num' " := ( URState (U:= DetailsInfoXchg ) DetailsInfoXchg_ι_price_num ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DetailsInfoXchg.price_denum' " := ( URState (U:= DetailsInfoXchg ) DetailsInfoXchg_ι_price_denum ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DetailsInfoXchg.min_amount' " := ( URState (U:= DetailsInfoXchg ) DetailsInfoXchg_ι_min_amount ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DetailsInfoXchg.sell_amount' " := ( URState (U:= DetailsInfoXchg ) DetailsInfoXchg_ι_sell_amount ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DetailsInfoXchg.buy_amount' " := ( URState (U:= DetailsInfoXchg ) DetailsInfoXchg_ι_buy_amount ) (in custom URValue at level 0) : ursus_scope. 
...
Notation " 'DTradingPair.flex_addr_' " := ( URState (U:= DTradingPair ) DTradingPair_ι_flex_addr_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DTradingPair.tip3_root_' " := ( URState (U:= DTradingPair ) DTradingPair_ι_tip3_root_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DTradingPair.deploy_value_' " := ( URState (U:= DTradingPair ) DTradingPair_ι_deploy_value_ ) (in custom URValue at level 0) : ursus_scope. 

Notation " 'DXchgPair.flex_addr_' " := ( URState (U:= DXchgPair ) DXchgPair_ι_flex_addr_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DXchgPair.tip3_major_root_' " := ( URState (U:= DXchgPair ) DXchgPair_ι_tip3_major_root_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DXchgPair.tip3_minor_root_' " := ( URState (U:= DXchgPair ) DXchgPair_ι_tip3_minor_root_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'DXchgPair.deploy_value_' " := ( URState (U:= DXchgPair ) DXchgPair_ι_deploy_value_ ) (in custom URValue at level 0) : ursus_scope. 
...
Notation " 'LocalState.uint256' " := ( URState (U:= LocalState ) LocalState_ι_uint256 ) (in custom URValue at level 0) : ursus_scope. 
 ...
 Notation " 'LocalState.DTradingPair' " := ( URState (U:= LocalState ) LocalState_ι_DTradingPair ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_ITradingPair_' " := ( URState (U:= LocalState ) LocalState_ι_handle_ITradingPair_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.DXchgPair' " := ( URState (U:= LocalState ) LocalState_ι_DXchgPair ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_IXchgPair_' " := ( URState (U:= LocalState ) LocalState_ι_handle_IXchgPair_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXSellArgs_' " := ( URState (U:= LocalState ) LocalState_ι_parse_FLeXSellArgs_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_IPrice_' " := ( URState (U:= LocalState ) LocalState_ι_handle_IPrice_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.SellArgs' " := ( URState (U:= LocalState ) LocalState_ι_SellArgs ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXBuyArgs_' " := ( URState (U:= LocalState ) LocalState_ι_parse_FLeXBuyArgs_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXCancelArgs_' " := ( URState (U:= LocalState ) LocalState_ι_parse_FLeXCancelArgs_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXXchgCancelArgs_' " := ( URState (U:= LocalState ) LocalState_ι_parse_FLeXXchgCancelArgs_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_IPriceXchg_' " := ( URState (U:= LocalState ) LocalState_ι_handle_IPriceXchg_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.bool_t' " := ( URState (U:= LocalState ) LocalState_ι_bool_t ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXXchgArgs_' " := ( URState (U:= LocalState ) LocalState_ι_parse_FLeXXchgArgs_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.PayloadArgs' " := ( URState (U:= LocalState ) LocalState_ι_PayloadArgs ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_ITONTokenWallet_' " := ( URState (U:= LocalState ) LocalState_ι_handle_ITONTokenWallet_ ) (in custom URValue at level 0) : ursus_scope. 
 ...
 Notation " 'LocalState.DPrice' " := ( URState (U:= LocalState ) LocalState_ι_DPrice ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.DPriceXchg' " := ( URState (U:= LocalState ) LocalState_ι_DPriceXchg ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.tuple_address_address' " := ( URState (U:= LocalState ) LocalState_ι_tuple_address_address ) (in custom URValue at level 0) : ursus_scope. 
 ...
 Notation " 'LocalState.optional_uint128_' " := ( URState (U:= LocalState ) LocalState_ι_optional_uint128_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.bool' " := ( URState (U:= LocalState ) LocalState_ι_bool ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.optional_OrderInfoWithIdx_' " := ( URState (U:= LocalState ) LocalState_ι_optional_OrderInfoWithIdx_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.queue_OrderInfo_' " := ( URState (U:= LocalState ) LocalState_ι_queue_OrderInfo_ ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.pair_unsigned_OrderInfo_' " := ( URState (U:= LocalState ) LocalState_ι_pair_unsigned_OrderInfo_ ) (in custom URValue at level 0) : ursus_scope. 

Notation " 'LocalState.uint256Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_uint256Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.cellIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_cellIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.TonsConfigIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_TonsConfigIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.addressIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_addressIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.uint128Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_uint128Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.StateInitIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_StateInitIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.DTradingPairIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_DTradingPairIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_ITradingPair_Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_handle_ITradingPair_Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.DXchgPairIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_DXchgPairIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_IXchgPair_Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_handle_IXchgPair_Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXSellArgs_Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_parse_FLeXSellArgs_Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_IPrice_Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_handle_IPrice_Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.SellArgsIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_SellArgsIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXBuyArgs_Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_parse_FLeXBuyArgs_Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXCancelArgs_Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_parse_FLeXCancelArgs_Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXXchgCancelArgs_Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_parse_FLeXXchgCancelArgs_Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_IPriceXchg_Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_handle_IPriceXchg_Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.bool_tIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_bool_tIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXXchgArgs_Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_parse_FLeXXchgArgs_Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.PayloadArgsIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_PayloadArgsIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_ITONTokenWallet_Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_handle_ITONTokenWallet_Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.uint8Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_uint8Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.Tip3ConfigIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_Tip3ConfigIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.DPriceIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_DPriceIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.DPriceXchgIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_DPriceXchgIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.tuple_address_addressIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_tuple_address_addressIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.uint32Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_uint32Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.unsignedIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_unsignedIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.OrderInfoIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_OrderInfoIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.intIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_intIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.optional_uint128_Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_optional_uint128_Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.boolIndex' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_boolIndex ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.optional_OrderInfoWithIdx_Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_optional_OrderInfoWithIdx_Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.queue_OrderInfo_Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_queue_OrderInfo_Index ) (in custom ULValue at level 0) : ursus_scope. 
 Notation " 'LocalState.pair_unsigned_OrderInfo_Index' " := ( ULState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_pair_unsigned_OrderInfo_Index ) (in custom ULValue at level 0) : ursus_scope. 

Notation " 'LocalState.uint256Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_uint256Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.cellIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_cellIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.TonsConfigIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_TonsConfigIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.addressIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_addressIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.uint128Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_uint128Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.StateInitIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_StateInitIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.DTradingPairIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_DTradingPairIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_ITradingPair_Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_handle_ITradingPair_Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.DXchgPairIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_DXchgPairIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_IXchgPair_Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_handle_IXchgPair_Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXSellArgs_Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_parse_FLeXSellArgs_Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_IPrice_Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_handle_IPrice_Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.SellArgsIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_SellArgsIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXBuyArgs_Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_parse_FLeXBuyArgs_Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXCancelArgs_Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_parse_FLeXCancelArgs_Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXXchgCancelArgs_Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_parse_FLeXXchgCancelArgs_Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_IPriceXchg_Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_handle_IPriceXchg_Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.bool_tIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_bool_tIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.parse_FLeXXchgArgs_Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_parse_FLeXXchgArgs_Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.PayloadArgsIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_PayloadArgsIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.handle_ITONTokenWallet_Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_handle_ITONTokenWallet_Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.uint8Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_uint8Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.Tip3ConfigIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_Tip3ConfigIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.DPriceIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_DPriceIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.DPriceXchgIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_DPriceXchgIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.tuple_address_addressIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_tuple_address_addressIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.uint32Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_uint32Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.unsignedIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_unsignedIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.OrderInfoIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_OrderInfoIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.intIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_intIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.optional_uint128_Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_optional_uint128_Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.boolIndex' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_boolIndex ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.optional_OrderInfoWithIdx_Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_optional_OrderInfoWithIdx_Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.queue_OrderInfo_Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_queue_OrderInfo_Index ) (in custom URValue at level 0) : ursus_scope. 
 Notation " 'LocalState.pair_unsigned_OrderInfo_Index' " := ( URState (H1:=embeddedT6) (U:=LocalState) LocalState_ι_pair_unsigned_OrderInfo_Index ) (in custom URValue at level 0) : ursus_scope. 
