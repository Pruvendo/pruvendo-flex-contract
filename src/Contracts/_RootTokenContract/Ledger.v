...
Inductive LocalStateFields00000I := | ι000000 | ι000001 . 
 ...
 Definition LocalState00110L := [ ( XHMap (string*nat) XInteger ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState01001L := [ ( XHMap (string*nat) XInteger8 ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState01010L := [ ( XHMap (string*nat) XInteger256 ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState01100L := [ ( XHMap (string*nat) XInteger (* parserLRecord *) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState01110L := [ ( XHMap (string*nat) XInteger8 ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState01111L := [ ( XHMap (string*nat) ( StateInitLRecord * XAddress ) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState10001L := [ ( XHMap (string*nat) XInteger (* record1 *) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState10010L := [ ( XHMap (string*nat) XInteger (* record2 *) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState10011L := [ ( XHMap (string*nat) XInteger (* record3 *) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState10100L := [ ( XHMap (string*nat) XInteger (* record4 *) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState10101L := [ ( XHMap (string*nat) XInteger (* record5 *) ) : Type ; ( XHMap string nat ) : Type ] . 
...
Remove Hints LocalStateField00101 : typeclass_instances. 
 #[global, program] Instance LocalStateField00110 : LocalStateField XInteger.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι00). 
 eapply TransEmbedded. eapply (_ ι001). 
...
Remove Hints LocalStateField00111 : typeclass_instances. 
 #[global, program] Instance LocalStateField01000 : LocalStateField XString.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
...
Remove Hints LocalStateField01000 : typeclass_instances. 
 #[global, program] Instance LocalStateField01001 : LocalStateField XInteger8.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι01). 
 eapply TransEmbedded. eapply (_ ι010). 
...
Remove Hints LocalStateField01001 : typeclass_instances. 
 #[global, program] Instance LocalStateField01010 : LocalStateField XInteger256.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι01). 
 eapply TransEmbedded. eapply (_ ι010). 
...
Remove Hints LocalStateField01011 : typeclass_instances. 
 #[global, program] Instance LocalStateField01100 : LocalStateField XInteger.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι01). 
...
Remove Hints LocalStateField01101 : typeclass_instances. 
 #[global, program] Instance LocalStateField01110 : LocalStateField XInteger8.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι01). 
 eapply TransEmbedded. eapply (_ ι011). 
...
Remove Hints LocalStateField01110 : typeclass_instances. 
 #[global, program] Instance LocalStateField01111 : LocalStateField ( StateInitLRecord * XAddress ).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι01). 
 eapply TransEmbedded. eapply (_ ι011). 
...
Remove Hints LocalStateField01111 : typeclass_instances. 
 #[global, program] Instance LocalStateField10000 : LocalStateField ContractLRecord.
Next Obligation. 
...
Remove Hints LocalStateField10000 : typeclass_instances. 
 #[global, program] Instance LocalStateField10001 : LocalStateField XInteger (* record1 *).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι100). 
 eapply TransEmbedded. eapply (_ ι1000). 
...
Remove Hints LocalStateField10001 : typeclass_instances. 
 #[global, program] Instance LocalStateField10010 : LocalStateField XInteger (* record2 *).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι100). 
...
Remove Hints LocalStateField10010 : typeclass_instances. 
 #[global, program] Instance LocalStateField10011 : LocalStateField XInteger (* record3 *).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι100). 
 eapply TransEmbedded. eapply (_ ι1001). 
...
Remove Hints LocalStateField10011 : typeclass_instances. 
 #[global, program] Instance LocalStateField10100 : LocalStateField XInteger (* record4 *).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
...
Remove Hints LocalStateField10100 : typeclass_instances. 
 #[global, program] Instance LocalStateField10101 : LocalStateField XInteger (* record5 *).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι101). 
