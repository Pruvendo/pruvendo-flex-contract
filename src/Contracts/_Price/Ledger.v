...
Inductive LocalStateFields00000I := | ι000000 | ι000001 . 
 Definition LocalState00000L := [ ( XHMap (string*nat) XCell ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState00001L := [ ( XHMap (string*nat) StateInitLRecord ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState00010L := [ ( XHMap (string*nat) ( StateInitLRecord * XInteger256 ) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState00100L := [ ( XHMap (string*nat) XInteger32 ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState00101L := [ ( XHMap (string*nat) ContractLRecord ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState00110L := [ ( XHMap (string*nat) ( XMaybe XInteger128 ) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState01000L := [ ( XHMap (string*nat) ( XBool * XBool * XInteger128 ) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState01001L := [ ( XHMap (string*nat) OrderInfoLRecord ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState01010L := [ ( XHMap (string*nat) XInteger ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState01011L := [ ( XHMap (string*nat) ( XMaybe ( XInteger * OrderInfoLRecord ) * XQueue OrderInfoLRecord * XInteger128 ) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState01100L := [ ( XHMap (string*nat) ( XMaybe ( XInteger * OrderInfoLRecord ) ) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState01101L := [ ( XHMap (string*nat) OrderRetLRecord ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState01110L := [ ( XHMap (string*nat) XInteger ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState10000L := [ ( XHMap (string*nat) process_retLRecord ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState10001L := [ ( XHMap (string*nat) XInteger8 ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState10010L := [ ( XHMap (string*nat) TonsConfigLRecord ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState10011L := [ ( XHMap (string*nat) ( XQueue OrderInfoLRecord * XInteger128 ) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState10100L := [ ( XHMap (string*nat) addr_std_fixedLRecord ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState10101L := [ ( XHMap (string*nat) XInteger (* Grams *) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState10110L := [ ( XHMap (string*nat) SellArgsLRecord ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState10111L := [ ( XHMap (string*nat) XAddress ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState11000L := [ ( XHMap (string*nat) DetailsInfoLRecord ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState11001L := [ ( XHMap (string*nat) ( XHMap XInteger OrderInfoLRecord ) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState11010L := [ ( XHMap (string*nat) ( XMaybe XAddress ) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState11011L := [ ( XHMap (string*nat) XAddress (* ITONTokenWalletPtrLRecord *) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState11100L := [ ( XHMap (string*nat) ( XAddress * XInteger (* Grams *) ) ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState11101L := [ ( XHMap (string*nat) XSlice ) : Type ; ( XHMap string nat ) : Type ] . 
 ...
 Definition LocalState11110L := [ ( XHMap (string*nat) ( XMaybe OrderRetLRecord ) ) : Type ; ( XHMap string nat ) : Type ] . 
...
#[global, program] Instance LocalStateField00000 : LocalStateField XCell.
Next Obligation. 
...
Remove Hints LocalStateField00000 : typeclass_instances. 
 #[global, program] Instance LocalStateField00001 : LocalStateField StateInitLRecord.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι00). 
 eapply TransEmbedded. eapply (_ ι000). 
...
Remove Hints LocalStateField00001 : typeclass_instances. 
 #[global, program] Instance LocalStateField00010 : LocalStateField ( StateInitLRecord * XInteger256 ).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι00). 
 eapply TransEmbedded. eapply (_ ι000). 
...
Remove Hints LocalStateField00011 : typeclass_instances. 
 #[global, program] Instance LocalStateField00100 : LocalStateField XInteger32.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι00). 
...
Remove Hints LocalStateField00100 : typeclass_instances. 
 #[global, program] Instance LocalStateField00101 : LocalStateField ContractLRecord.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι00). 
 eapply TransEmbedded. eapply (_ ι001). 
...
Remove Hints LocalStateField00101 : typeclass_instances. 
 #[global, program] Instance LocalStateField00110 : LocalStateField ( XMaybe XInteger128 ).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι00). 
 eapply TransEmbedded. eapply (_ ι001). 
...
Remove Hints LocalStateField00111 : typeclass_instances. 
 #[global, program] Instance LocalStateField01000 : LocalStateField ( XBool * XBool * XInteger128 ).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
...
Remove Hints LocalStateField01000 : typeclass_instances. 
 #[global, program] Instance LocalStateField01001 : LocalStateField OrderInfoLRecord.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι01). 
 eapply TransEmbedded. eapply (_ ι010). 
...
Remove Hints LocalStateField01001 : typeclass_instances. 
 #[global, program] Instance LocalStateField01010 : LocalStateField XInteger.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι01). 
 eapply TransEmbedded. eapply (_ ι010). 
...
Remove Hints LocalStateField01010 : typeclass_instances. 
 #[global, program] Instance LocalStateField01011 : LocalStateField ( XMaybe ( XInteger * OrderInfoLRecord ) * XQueue OrderInfoLRecord * XInteger128 ).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι01). 
 eapply TransEmbedded. eapply (_ ι010). 
...
Remove Hints LocalStateField01011 : typeclass_instances. 
 #[global, program] Instance LocalStateField01100 : LocalStateField ( XMaybe ( XInteger * OrderInfoLRecord ) ).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι01). 
...
Remove Hints LocalStateField01100 : typeclass_instances. 
 #[global, program] Instance LocalStateField01101 : LocalStateField OrderRetLRecord.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι01). 
 eapply TransEmbedded. eapply (_ ι011). 
...
Remove Hints LocalStateField01101 : typeclass_instances. 
 #[global, program] Instance LocalStateField01110 : LocalStateField XInteger.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι0). 
 eapply TransEmbedded. eapply (_ ι01). 
 eapply TransEmbedded. eapply (_ ι011). 
...
Remove Hints LocalStateField01111 : typeclass_instances. 
 #[global, program] Instance LocalStateField10000 : LocalStateField process_retLRecord.
Next Obligation. 
...
Remove Hints LocalStateField10000 : typeclass_instances. 
 #[global, program] Instance LocalStateField10001 : LocalStateField XInteger8.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι10). 
 eapply TransEmbedded. eapply (_ ι100). 
...
Remove Hints LocalStateField10001 : typeclass_instances. 
 #[global, program] Instance LocalStateField10010 : LocalStateField TonsConfigLRecord.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι10). 
 eapply TransEmbedded. eapply (_ ι100). 
...
Remove Hints LocalStateField10010 : typeclass_instances. 
 #[global, program] Instance LocalStateField10011 : LocalStateField ( XQueue OrderInfoLRecord * XInteger128 ).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι10). 
 eapply TransEmbedded. eapply (_ ι100). 
...
Remove Hints LocalStateField10011 : typeclass_instances. 
 #[global, program] Instance LocalStateField10100 : LocalStateField addr_std_fixedLRecord.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι10). 
...
Remove Hints LocalStateField10100 : typeclass_instances. 
 #[global, program] Instance LocalStateField10101 : LocalStateField XInteger (* Grams *).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι10). 
 eapply TransEmbedded. eapply (_ ι101). 
...
Remove Hints LocalStateField10101 : typeclass_instances. 
 #[global, program] Instance LocalStateField10110 : LocalStateField SellArgsLRecord.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι10). 
 eapply TransEmbedded. eapply (_ ι101). 
...
Remove Hints LocalStateField10110 : typeclass_instances. 
 #[global, program] Instance LocalStateField10111 : LocalStateField XAddress.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι10). 
 eapply TransEmbedded. eapply (_ ι101). 
...
Remove Hints LocalStateField10111 : typeclass_instances. 
 #[global, program] Instance LocalStateField11000 : LocalStateField DetailsInfoLRecord.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
...
Remove Hints LocalStateField11000 : typeclass_instances. 
 #[global, program] Instance LocalStateField11001 : LocalStateField ( XHMap XInteger OrderInfoLRecord ).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι11). 
 eapply TransEmbedded. eapply (_ ι110). 
...
Remove Hints LocalStateField11001 : typeclass_instances. 
 #[global, program] Instance LocalStateField11010 : LocalStateField ( XMaybe XAddress ).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι11). 
 eapply TransEmbedded. eapply (_ ι110). 
...
Remove Hints LocalStateField11010 : typeclass_instances. 
 #[global, program] Instance LocalStateField11011 : LocalStateField XAddress (* TONTokenWalletLRecord *).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι11). 
 eapply TransEmbedded. eapply (_ ι110). 
...
Remove Hints LocalStateField11011 : typeclass_instances. 
 #[global, program] Instance LocalStateField11100 : LocalStateField ( XAddress * XInteger (* Grams *) ).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι11). 
...
Remove Hints LocalStateField11100 : typeclass_instances. 
 #[global, program] Instance LocalStateField11101 : LocalStateField XSlice.
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι11). 
 eapply TransEmbedded. eapply (_ ι111). 
...
Remove Hints LocalStateField11101 : typeclass_instances. 
 #[global, program] Instance LocalStateField11110 : LocalStateField ( XMaybe OrderRetLRecord ).
Next Obligation. 
 eapply TransEmbedded. eapply (_ ι1). 
 eapply TransEmbedded. eapply (_ ι11). 
 eapply TransEmbedded. eapply (_ ι111). 
