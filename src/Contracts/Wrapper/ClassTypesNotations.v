...
Definition WrapperRet_ι_err_code_right {b} (x: URValue WrapperRetLRecord b): URValue XInteger32 b :=
    || {x} ^^ {WrapperRet_ι_err_code} || : _ .
    
Definition WrapperRet_ι_err_code_left (x: ULValue WrapperRetLRecord): ULValue XInteger32 :=
    {{ {x} ^^ {WrapperRet_ι_err_code} }} : _.
...
Definition FlexDeployWalletArgs_ι_pubkey_right {b} (x: URValue FlexDeployWalletArgsLRecord b): URValue XInteger256 b :=
    || {x} ^^ {FlexDeployWalletArgs_ι_pubkey} || : _ .
    
Definition FlexDeployWalletArgs_ι_pubkey_left (x: ULValue FlexDeployWalletArgsLRecord): ULValue XInteger256 :=
    {{ {x} ^^ {FlexDeployWalletArgs_ι_pubkey} }} : _.
...
Definition FlexDeployWalletArgs_ι_grams_right {b} (x: URValue FlexDeployWalletArgsLRecord b): URValue XInteger128 b :=
    || {x} ^^ {FlexDeployWalletArgs_ι_grams} || : _ .
    
Definition FlexDeployWalletArgs_ι_grams_left (x: ULValue FlexDeployWalletArgsLRecord): ULValue XInteger128 :=
    {{ {x} ^^ {FlexDeployWalletArgs_ι_grams} }} : _.
...
Definition wrapper_details_info_ι_decimals_right {b} (x: URValue wrapper_details_infoLRecord b): URValue XInteger8 b :=
    || {x} ^^ {wrapper_details_info_ι_decimals} || : _ .
    
Definition wrapper_details_info_ι_decimals_left (x: ULValue wrapper_details_infoLRecord): ULValue XInteger8 :=
    {{ {x} ^^ {wrapper_details_info_ι_decimals} }} : _.
...
Definition wrapper_details_info_ι_root_public_key_right {b} (x: URValue wrapper_details_infoLRecord b): URValue XInteger256 b :=
    || {x} ^^ {wrapper_details_info_ι_root_public_key} || : _ .
    
Definition wrapper_details_info_ι_root_public_key_left (x: ULValue wrapper_details_infoLRecord): ULValue XInteger256 :=
    {{ {x} ^^ {wrapper_details_info_ι_root_public_key} }} : _.
...
Definition wrapper_details_info_ι_total_granted_right {b} (x: URValue wrapper_details_infoLRecord b): URValue XInteger128 b :=
    || {x} ^^ {wrapper_details_info_ι_total_granted} || : _ .
    
Definition wrapper_details_info_ι_total_granted_left (x: ULValue wrapper_details_infoLRecord): ULValue XInteger128 :=
    {{ {x} ^^ {wrapper_details_info_ι_total_granted} }} : _.
...
Definition DWrapper_ι_decimals__right {b} (x: URValue DWrapperFieldsLRecord b): URValue XInteger8 b :=
    || {x} ^^ {DWrapper_ι_decimals_} || : _ .
    
Definition DWrapper_ι_decimals__left (x: ULValue DWrapperFieldsLRecord): ULValue XInteger8 :=
    {{ {x} ^^ {DWrapper_ι_decimals_} }} : _.
...
Definition DWrapper_ι_workchain_id__right {b} (x: URValue DWrapperFieldsLRecord b): URValue XInteger8 b :=
    || {x} ^^ {DWrapper_ι_workchain_id_} || : _ .
    
Definition DWrapper_ι_workchain_id__left (x: ULValue DWrapperFieldsLRecord): ULValue XInteger8 :=
    {{ {x} ^^ {DWrapper_ι_workchain_id_} }} : _.
...
Definition DWrapper_ι_root_public_key__right {b} (x: URValue DWrapperFieldsLRecord b): URValue XInteger256 b :=
    || {x} ^^ {DWrapper_ι_root_public_key_} || : _ .
    
Definition DWrapper_ι_root_public_key__left (x: ULValue DWrapperFieldsLRecord): ULValue XInteger256 :=
    {{ {x} ^^ {DWrapper_ι_root_public_key_} }} : _.
...
Definition DWrapper_ι_total_granted__right {b} (x: URValue DWrapperFieldsLRecord b): URValue XInteger128 b :=
    || {x} ^^ {DWrapper_ι_total_granted_} || : _ .
    
Definition DWrapper_ι_total_granted__left (x: ULValue DWrapperFieldsLRecord): ULValue XInteger128 :=
    {{ {x} ^^ {DWrapper_ι_total_granted_} }} : _.
