...
Module TONTokenWalletPublicInterface := TONTokenWallet.Interface.PublicInterface xt sm.
...
Definition transfer_left { R a1 a2 a3 a4 a5 }  
                          ...
                          ( tokens : URValue ( XUInteger128 ) a3 ) 
                          ( grams : URValue ( XUInteger128 ) a4 ) 
                          ( return_ownership : URValue ( XBool ) a5 ) : UExpression R true  := 
 wrapULExpression (ursus_call_with_args (LedgerableWithArgs:= λ5 ) transfer answer_addr too tokens grams return_ownership ) . 
 
Notation " 'transfer_' '(' answer_addr too tokens grams return_ownership ')' " := 
 ( transfer_left answer_addr too tokens grams return_ownership ) 
 (in custom ULValue at level 0 , answer_addr custom URValue at level 0 , too custom URValue at level 0 
 , tokens custom URValue at level 0 , grams custom URValue at level 0 , return_ownership custom URValue at level 0 ) : ursus_scope . 
 
Definition transferWithNotify_left { R a1 a2 a3 a4 a5 a6 }  
                                   ( answer_addr : URValue ( address ) a1 ) 
                                   ( too : URValue ( address ) a2 ) 
                                   ( tokens : URValue ( XUInteger128 ) a3 ) 
                                   ( grams : URValue ( XUInteger128 ) a4 ) 
                                   ( return_ownership : URValue ( XBool ) a5 ) 
                                   ( payload : URValue cell a6 ) : UExpression R true  := 
 wrapULExpression (ursus_call_with_args (LedgerableWithArgs:= λ6 ) transferWithNotify answer_addr too tokens grams return_ownership payload ) . 
 
Notation " 'transferWithNotify_' '(' answer_addr too tokens grams return_ownership payload ')' " := 
 ( transferWithNotify_left  answer_addr too tokens grams return_ownership payload ) 
 (in custom ULValue at level 0 , answer_addr custom URValue at level 0 , too custom URValue at level 0 
...
Definition transferToRecipient_left { R a1 a2 a3 a4 a5 a6 a7 }  
                                    ( answer_addr : URValue ( address ) a1 ) 
                                    ( recipient_public_key : URValue ( XUInteger256 ) a2 ) 
                                    ( recipient_internal_owner : URValue ( address ) a3 ) 
                                    ( tokens : URValue ( XUInteger128 ) a4 )
                                    ( grams : URValue ( XUInteger128 ) a5 ) 
                                    ( deploy : URValue ( XBool ) a6 ) 
                                    ( return_ownership : URValue ( XBool ) a7 ) 
                                    : UExpression R true  := 
wrapULExpression (ursus_call_with_args (LedgerableWithArgs:= λ7 ) transferToRecipient answer_addr recipient_public_key recipient_internal_owner tokens grams deploy return_ownership ) . 
...
Notation " 'transferToRecipient_' '(' answer_addr recipient_public_key recipient_internal_owner tokens grams deploy return_ownership ')' " := 
 ( transferToRecipient_left answer_addr recipient_public_key recipient_internal_owner tokens grams deploy return_ownership ) 
 ...
 , deploy custom URValue at level 0 , return_ownership custom URValue at level 0 ) : ursus_scope . 
 
Definition transferToRecipientWithNotify_left { R a1 a2 a3 a4 a5 a6 a7 a8 }  
                                              ( answer_addr : URValue ( address ) a1 ) 
                                              ( recipient_public_key : URValue ( XUInteger256 ) a2 ) 
                                              ( recipient_internal_owner : URValue ( address ) a3 ) 
                                              ( tokens : URValue ( XUInteger128 ) a4 ) 
                                              ...
                                              ( deploy : URValue ( XBool ) a6 ) 
                                              ( return_ownership : URValue ( XBool ) a7 ) 
                                              ( payload : URValue cell a8 )
                                              : UExpression R true  := 
 wrapULExpression (ursus_call_with_args (LedgerableWithArgs:= λ8 ) transferToRecipientWithNotify answer_addr recipient_public_key recipient_internal_owner tokens grams deploy return_ownership payload ) . 
...
Notation " 'transferToRecipientWithNotify_' '(' answer_addr recipient_public_key recipient_internal_owner tokens grams deploy return_ownership payload ')' " := 
 ( transferToRecipientWithNotify_left answer_addr recipient_public_key recipient_internal_owner tokens grams deploy return_ownership payload ) 
 (in custom ULValue at level 0 , answer_addr custom URValue at level 0 , recipient_public_key custom URValue at level 0 
 , recipient_internal_owner custom URValue at level 0 , tokens custom URValue at level 0 
 , grams custom URValue at level 0 , deploy custom URValue at level 0 
 , return_ownership custom URValue at level 0 , payload custom URValue at level 0 ) : ursus_scope . 
...
Notation " 'requestBalance_' '(' ')' " := ( requestBalance_right ) 
 (in custom URValue at level 0 ) : ursus_scope . 

Definition accept_right { a1 a2 a3 }  
                        ( tokens : URValue ( XUInteger128 ) a1 ) 
                        ( answer_addr : URValue ( address ) a2 ) 
                        ( keep_grams : URValue ( XUInteger128 ) a3 ) : URValue XBool true := 
 wrapURExpression (ursus_call_with_args (LedgerableWithArgs:= λ3 ) accept tokens answer_addr keep_grams ) . 
 
Notation " 'accept_' '(' tokens answer_addr keep_grams ')' " :=  ( accept_right tokens answer_addr keep_grams ) 
 (in custom URValue at level 0 , tokens custom URValue at level 0 
 , answer_addr custom URValue at level 0 , keep_grams custom URValue at level 0 ) : ursus_scope . 
 
Definition internalTransfer_left { R a1 a2 a3 a4 a5 a6 }  
                                 ( tokens : URValue ( XUInteger128 ) a1 ) 
                                 ( answer_addr : URValue ( address ) a2 ) 
                                 ( sender_pubkey : URValue ( XUInteger256 ) a3 ) 
                                 ( sender_owner : URValue ( address ) a4 ) 
                                 ( notify_receiver : URValue ( XBool ) a5 ) 
                                 ( payload : URValue cell a6 ) : UExpression R true := 
 wrapULExpression (ursus_call_with_args (LedgerableWithArgs:= λ6 ) internalTransfer tokens answer_addr sender_pubkey sender_owner notify_receiver payload ) . 
 
Notation " 'internalTransfer_' '(' tokens answer_addr sender_pubkey sender_owner notify_receiver payload ')' " := 
 ( internalTransfer_left tokens answer_addr sender_pubkey sender_owner notify_receiver payload ) 
 (in custom ULValue at level 0 , tokens custom URValue at level 0 , answer_addr custom URValue at level 0 
 , sender_pubkey custom URValue at level 0 , sender_owner custom URValue at level 0 
 , notify_receiver custom URValue at level 0 , payload custom URValue at level 0 ) : ursus_scope . 
 
Definition destroy_left { R a1 }  ( dest : URValue ( address ) a1 ) : UExpression R true := 
 wrapULExpression (ursus_call_with_args (LedgerableWithArgs:= λ1 ) destroy dest ) . 
 
Notation " 'destroy_' '(' dest ')' " := ( destroy_left dest ) 
 (in custom ULValue at level 0 , dest custom URValue at level 0 ) : ursus_scope . 
 
Definition burn_left { R a1 a2 }  ( out_pubkey : URValue ( XUInteger256 ) a1 ) 
                     ( out_internal_owner : URValue ( address ) a2 ) 
                     : UExpression R true  := 
 wrapULExpression (ursus_call_with_args (LedgerableWithArgs:= λ2 ) burn out_pubkey out_internal_owner ) . 
 
Notation " 'burn_' '(' out_pubkey out_internal_owner ')' " := 
 ( burn_left out_pubkey out_internal_owner ) 
 (in custom ULValue at level 0 , out_pubkey custom URValue at level 0 , out_internal_owner custom URValue at level 0 ) : ursus_scope . 
 
Definition lendOwnership_left { R a1 a2 a3 a4 a5 a6 a7 }  
                              ( answer_addr : URValue ( address ) a1 ) 
                              ( grams : URValue ( XUInteger128 ) a2 ) 
                              ( std_dest : URValue ( XUInteger256 ) a3 ) 
                              ( lend_balance : URValue ( XUInteger128 ) a4 ) 
                              ( lend_finish_time : URValue ( XUInteger32 ) a5 ) 
                              ( deploy_init_cl : URValue cell a6 ) 
                              ( payload : URValue cell a7 ) 
                              : UExpression R true := 
...
Notation " 'lendOwnership_' '(' answer_addr grams std_dest lend_balance lend_finish_time deploy_init_cl payload ')' " := 
 ( lendOwnership_left answer_addr grams std_dest lend_balance lend_finish_time deploy_init_cl payload ) 
 (in custom ULValue at level 0 , answer_addr custom URValue at level 0 
 , grams custom URValue at level 0  , std_dest custom URValue at level 0 
 , lend_balance custom URValue at level 0 , lend_finish_time custom URValue at level 0 
 , deploy_init_cl custom URValue at level 0 , payload custom URValue at level 0 ) : ursus_scope . 
 
 Definition returnOwnership_left { R a1 }  ( tokens : URValue ( XUInteger128 ) a1 ) : UExpression R true (* a1 *) := 
 wrapULExpression (ursus_call_with_args (LedgerableWithArgs:= λ1 ) returnOwnership tokens ) . 
 
 Notation " 'returnOwnership_' '(' tokens ')' " := ( returnOwnership_left tokens ) 
 (in custom ULValue at level 0 , tokens custom URValue at level 0 ) : ursus_scope . 
 
Definition getDetails_right  : URValue details_infoLRecord true := 
...
Notation " 'getName_' '(' ')' " := ( getName_right ) (in custom URValue at level 0 ) : ursus_scope . 
...
Definition approve_left { R a1 a2 a3 }  ( spender : URValue ( address ) a1 ) 
                                        ( remainingTokens : URValue ( XUInteger128 ) a2 ) 
                                        ( tokens : URValue ( XUInteger128 ) a3 ) 
                                        : UExpression R true := 
 wrapULExpression (ursus_call_with_args (LedgerableWithArgs:= λ3 ) approve spender remainingTokens tokens ) . 
 
Notation " 'approve_' '(' spender remainingTokens tokens ')' " := 
( approve_left spender remainingTokens tokens ) 
 (in custom ULValue at level 0 , spender custom URValue at level 0 
 , remainingTokens custom URValue at level 0 , tokens custom URValue at level 0 ) : ursus_scope . 
 
Definition transferFrom_left { R a1 a2 a3 a4 a5 }  
                             ( answer_addr : URValue ( address ) a1 ) 
                             ...
                             ( grams : URValue ( XUInteger128 ) a5 ) 
                             : UExpression R true := 
 wrapULExpression (ursus_call_with_args (LedgerableWithArgs:= λ5 ) transferFrom answer_addr from too tokens grams ) . 
 
Notation " 'transferFrom_' '(' answer_addr from too tokens grams ')' " := 
 ( transferFrom_left answer_addr from too tokens grams ) 
 (in custom ULValue at level 0 , answer_addr custom URValue at level 0 
 , from custom URValue at level 0  , too custom URValue at level 0 
 , tokens custom URValue at level 0 , grams custom URValue at level 0 ) : ursus_scope . 
 
Definition transferFromWithNotify_left { R a1 a2 a3 a4 a5 a6 }  
                                        ( answer_addr : URValue ( address ) a1 ) 
                                        ( from : URValue ( address ) a2 ) 
                                        ( too : URValue ( address ) a3 ) 
                                        ( tokens : URValue ( XUInteger128 ) a4 ) 
                                        ( grams : URValue ( XUInteger128 ) a5 ) 
                                        ( payload : URValue cell a6 ) 
                                        : UExpression R true := 
 wrapULExpression (ursus_call_with_args (LedgerableWithArgs:= λ6 ) transferFromWithNotify answer_addr from too tokens grams payload ) . 
 
Notation " 'transferFromWithNotify_' '(' answer_addr from too tokens grams payload ')' " := 
 ( transferFromWithNotify_left answer_addr from too tokens grams payload ) 
 (in custom ULValue at level 0 , answer_addr custom URValue at level 0 
 , from custom URValue at level 0 , too custom URValue at level 0 
 , tokens custom URValue at level 0 , grams custom URValue at level 0 
 , payload custom URValue at level 0 ) : ursus_scope . 
...
Definition internalTransferFrom_left { R a1 a2 a3 a4 a5 }  ( answer_addr : URValue ( address ) a1 ) ( too : URValue ( address ) a2 ) ( tokens : URValue ( XUInteger128 ) a3 ) ( notify_receiver : URValue ( XBool ) a4 ) ( payload : URValue cell a5 ) : UExpression R true := 
 wrapULExpression (ursus_call_with_args (LedgerableWithArgs:= λ5 ) internalTransferFrom answer_addr too tokens notify_receiver payload ) . 
 
Notation " 'internalTransferFrom_' '(' answer_addr too tokens notify_receiver payload ')' " := 
 ( internalTransferFrom_left answer_addr too tokens notify_receiver payload ) 
 (in custom ULValue at level 0 , answer_addr custom URValue at level 0 
 , too custom URValue at level 0 , tokens custom URValue at level 0 
 , notify_receiver custom URValue at level 0 , payload custom URValue at level 0 ) : ursus_scope . 
 
Definition disapprove_left { R }  : UExpression R true := 
 wrapULExpression (ursus_call_with_args (LedgerableWithArgs:= λ0 ) disapprove ) . 
 
Notation " 'disapprove_' '(' ')' " := ( disapprove_left ) 
 (in custom ULValue at level 0 ) : ursus_scope . 

Definition _on_bounced_right { a1 a2 }  ( msg : URValue cell a1 ) ( msg_body : URValue ( slice ) a2 ) : URValue XUInteger true := 
 wrapURExpression (ursus_call_with_args (LedgerableWithArgs:= λ2 ) _on_bounced msg msg_body ) . 
 
Notation " '_on_bounced_' '(' msg msg_body ')' " := ( _on_bounced_right msg msg_body ) 
...
Definition _fallback_right { a1 a2 }  ( cell : URValue cell a1 ) ( msg_body : URValue ( slice ) a2 ) : URValue XUInteger true := 
 wrapURExpression (ursus_call_with_args (LedgerableWithArgs:= λ2 ) _fallback cell msg_body ) . 
 
Notation " '_fallback_' '(' cell msg_body ')' " := ( _fallback_right cell msg_body ) 
 (in custom URValue at level 0 , cell custom URValue at level 0 , msg_body custom URValue at level 0 ) : ursus_scope . 
 
Definition transfer_impl_left { R a1 a2 a3 a4 a5 a6 a7 }  
                              ( answer_addr : URValue ( address ) a1 ) 
                              ( too : URValue ( address ) a2 ) 
                              ( tokens : URValue ( XUInteger128 ) a3 ) 
                              ( grams : URValue ( XUInteger128 ) a4 ) 
                              ( return_ownership : URValue ( XBool ) a5 ) 
                              ( send_notify : URValue ( XBool ) a6 ) 
...
Notation " 'transfer_impl_' '(' answer_addr too tokens grams return_ownership send_notify payload ')' " := 
 ...
 (in custom ULValue at level 0 , answer_addr custom URValue at level 0 
 , too custom URValue at level 0 , tokens custom URValue at level 0 
 , grams custom URValue at level 0 , return_ownership custom URValue at level 0 
...
Notation " 'get_owner_addr_' '(' ')' " := ( get_owner_addr_right ) 
 (in custom URValue at level 0 ) : ursus_scope . 
...
Notation " 'fixup_answer_addr_' '(' answer_addr ')' " := ( fixup_answer_addr_right answer_addr ) 
 (in custom URValue at level 0 , answer_addr custom URValue at level 0 ) : ursus_scope . 

Definition check_transfer_requires_right { a1 a2 }  ( tokens : URValue ( XUInteger128 ) a1 ) 
                                         ( grams : URValue ( XUInteger128 ) a2 ) 
                                         : URValue XUInteger128 true := 
 wrapURExpression (ursus_call_with_args (LedgerableWithArgs:= λ2 ) check_transfer_requires tokens grams ) . 
 
Notation " 'check_transfer_requires_' '(' tokens grams ')' " := ( check_transfer_requires_right tokens grams ) 
...
Definition update_spent_balance_left { R a1 a2 }  ( tokens : URValue ( XUInteger128 ) a1 ) ( return_ownership : URValue ( XBool ) a2 ) : UExpression R true := 
 wrapULExpression (ursus_call_with_args (LedgerableWithArgs:= λ2 ) update_spent_balance tokens return_ownership ) . 
 
Notation " 'update_spent_balance_' '(' tokens return_ownership ')' " := ( update_spent_balance_left tokens return_ownership ) 
...
Definition calc_wallet_init_hash_right { a1 a2 }  ( pubkey : URValue ( XUInteger256 ) a1 ) 
                                       ( internal_owner : URValue ( address ) a2 ) 
                                       : URValue ( StateInitLRecord # XUInteger256 ) ( orb a2 a1 ) := 
...
Notation " 'calc_wallet_init_hash_' '(' pubkey internal_owner ')' " := 
 ( calc_wallet_init_hash_right pubkey internal_owner ) 
...
Notation " 'expected_sender_address_' '(' sender_public_key sender_owner ')' " := 
 ...
 (in custom URValue at level 0 , sender_public_key custom URValue at level 0 , sender_owner custom URValue at level 0 ) : ursus_scope .
...
Definition check_internal_owner_right { a1 a2 }  ( original_owner_only : URValue ( XBool ) a1 ) 
                                      ( allowed_for_original_owner_in_lend_state : URValue ( XBool ) a2 ) 
                                      : URValue XUInteger128 true := 
...
Notation " 'check_internal_owner_' '(' original_owner_only allowed_for_original_owner_in_lend_state ')' " := 
 ...
 (in custom URValue at level 0 , original_owner_only custom URValue at level 0 , allowed_for_original_owner_in_lend_state custom URValue at level 0 ) : ursus_scope . 
...
Definition check_owner_right { a1 a2 }  ( original_owner_only : URValue ( XBool ) a1 ) 
                                        ( allowed_in_lend_state : URValue ( XBool ) a2 ) 
                                        : URValue XUInteger128 true := 
