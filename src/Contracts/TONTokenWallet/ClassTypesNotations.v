...
Definition allowance_info_ι_remainingTokens_right {b} (x: URValue allowance_infoLRecord b): URValue XInteger128 b :=
    || {x} ^^ {allowance_info_ι_remainingTokens} || : _.
    
Definition allowance_info_ι_remainingTokens_left (x: ULValue allowance_infoLRecord): ULValue XInteger128 :=
    {{ {x} ^^ {allowance_info_ι_remainingTokens} }} : _.
...
Definition lend_record_ι_lend_balance_right {b} (x: URValue lend_recordLRecord b): URValue XInteger128 b :=
    || {x} ^^ {lend_record_ι_lend_balance} || : _.
    
Definition lend_record_ι_lend_balance_left (x: ULValue lend_recordLRecord): ULValue XInteger128 :=
    {{ {x} ^^ {lend_record_ι_lend_balance} }} : _.
...
Definition lend_record_ι_lend_finish_time_right {b} (x: URValue lend_recordLRecord b): URValue XInteger32 b :=
    || {x} ^^ {lend_record_ι_lend_finish_time} || : _.
    
Definition lend_record_ι_lend_finish_time_left (x: ULValue lend_recordLRecord): ULValue XInteger32 :=
    {{ {x} ^^ {lend_record_ι_lend_finish_time} }} : _.
...
Definition lend_array_record_ι_lend_balance_right {b} (x: URValue lend_array_recordLRecord b): URValue XInteger128 b :=
    || {x} ^^ {lend_array_record_ι_lend_balance} || : _.
    
Definition lend_array_record_ι_lend_balance_left (x: ULValue lend_array_recordLRecord): ULValue XInteger128 :=
    {{ {x} ^^ {lend_array_record_ι_lend_balance} }} : _.
...
Definition lend_array_record_ι_lend_finish_time_right {b} (x: URValue lend_array_recordLRecord b): URValue XInteger32 b :=
    || {x} ^^ {lend_array_record_ι_lend_finish_time} || : _.
    
Definition lend_array_record_ι_lend_finish_time_left (x: ULValue lend_array_recordLRecord): ULValue XInteger32 :=
    {{ {x} ^^ {lend_array_record_ι_lend_finish_time} }} : _.
...
Definition details_info_ι_decimals_right {b} (x: URValue details_infoLRecord b): URValue XInteger8 b :=
    || {x} ^^ {details_info_ι_decimals} || : _.
    
Definition details_info_ι_decimals_left (x: ULValue details_infodLRecord): ULValue XInteger8 :=
    {{ {x} ^^ {details_info_ι_decimals} }} : _.
...
Definition details_info_ι_balance_right {b} (x: URValue details_infoLRecord b): URValue XInteger128 b :=
    || {x} ^^ {details_info_ι_balance} || : _.
    
Definition details_info_ι_balance_left (x: ULValue details_infodLRecord): ULValue XInteger128 :=
    {{ {x} ^^ {details_info_ι_balance} }} : _.
...
Definition details_info_ι_root_public_key_right {b} (x: URValue details_infoLRecord b): URValue XInteger256 b :=
    || {x} ^^ {details_info_ι_root_public_key} || : _.
    
Definition details_info_ι_root_public_key_left (x: ULValue details_infodLRecord): ULValue XInteger256 :=
    {{ {x} ^^ {details_info_ι_root_public_key} }} : _.
...
Definition details_info_ι_wallet_public_key_right {b} (x: URValue details_infoLRecord b): URValue XInteger256 b :=
    || {x} ^^ {details_info_ι_wallet_public_key} || : _.
    
Definition details_info_ι_wallet_public_key_left (x: ULValue details_infodLRecord): ULValue XInteger256 :=
    {{ {x} ^^ {details_info_ι_wallet_public_key} }} : _.
...
Definition details_info_ι_lend_ownership_right {b} (x: URValue details_infoLRecord b): URValue ( XHMap XInteger lend_array_recordLRecord ) b :=
    || {x} ^^ {details_info_ι_lend_ownership} || : _.
    
Definition details_info_ι_lend_ownership_left (x: ULValue details_infodLRecord): ULValue ( XHMap XInteger lend_array_recordLRecord ) :=
    {{ {x} ^^ {details_info_ι_lend_ownership} }} : _.
...
Definition details_info_ι_lend_balance_right {b} (x: URValue details_infoLRecord b): URValue XInteger128 b :=
    || {x} ^^ {details_info_ι_lend_balance} || : _.
    
Definition details_info_ι_lend_balance_left (x: ULValue details_infodLRecord): ULValue XInteger128 :=
    {{ {x} ^^ {details_info_ι_lend_balance} }} : _.
...
Definition details_info_ι_workchain_id_right {b} (x: URValue details_infoLRecord b): URValue XInteger8 b :=
    || {x} ^^ {details_info_ι_workchain_id} || : _.
    
Definition details_info_ι_workchain_id_left (x: ULValue details_infodLRecord): ULValue XInteger8 :=
    {{ {x} ^^ {details_info_ι_workchain_id} }} : _.
...
Definition DTONTokenWalletExternal_ι_decimals__right {b} (x: URValue DTONTokenWalletExternalLRecord b): URValue XInteger8 b :=
    || {x} ^^ {DTONTokenWalletExternal_ι_decimals_} || : _.
    
Definition DTONTokenWalletExternal_ι_decimals__left (x: ULValue DTONTokenWalletExternalLRecord): ULValue XInteger8 :=
    {{ {x} ^^ {DTONTokenWalletExternal_ι_decimals_} }} : _.
...
Definition DTONTokenWalletExternal_ι_balance__right {b} (x: URValue DTONTokenWalletExternalLRecord b): URValue XInteger128 b :=
    || {x} ^^ {DTONTokenWalletExternal_ι_balance_} || : _.
    
Definition DTONTokenWalletExternal_ι_balance__left (x: ULValue DTONTokenWalletExternalLRecord): ULValue XInteger128 :=
    {{ {x} ^^ {DTONTokenWalletExternal_ι_balance_} }} : _.
...
Definition DTONTokenWalletExternal_ι_root_public_key__right {b} (x: URValue DTONTokenWalletExternalLRecord b): URValue XInteger256 b :=
    || {x} ^^ {DTONTokenWalletExternal_ι_root_public_key_} || : _.
    
Definition DTONTokenWalletExternal_ι_root_public_key__left (x: ULValue DTONTokenWalletExternalLRecord): ULValue XInteger256 :=
    {{ {x} ^^ {DTONTokenWalletExternal_ι_root_public_key_} }} : _.
...
Definition DTONTokenWalletExternal_ι_wallet_public_key__right {b} (x: URValue DTONTokenWalletExternalLRecord b): URValue XInteger256 b :=
    || {x} ^^ {DTONTokenWalletExternal_ι_wallet_public_key_} || : _.
    
Definition DTONTokenWalletExternal_ι_wallet_public_key__left (x: ULValue DTONTokenWalletExternalLRecord): ULValue XInteger256 :=
    {{ {x} ^^ {DTONTokenWalletExternal_ι_wallet_public_key_} }} : _.
...
Definition DTONTokenWalletExternal_ι_workchain_id__right {b} (x: URValue DTONTokenWalletExternalLRecord b): URValue XInteger8 b :=
    || {x} ^^ {DTONTokenWalletExternal_ι_workchain_id_} || : _.
    
Definition DTONTokenWalletExternal_ι_workchain_id__left (x: ULValue DTONTokenWalletExternalLRecord): ULValue XInteger8 :=
    {{ {x} ^^ {DTONTokenWalletExternal_ι_workchain_id_} }} : _.
...
Definition DTONTokenWalletInternal_ι_decimals__right {b} (x: URValueDTONTokenWalletInternalLRecord b): URValue XInteger8 b :=
    || {x} ^^ {DTONTokenWalletInternal_ι_decimals_} || : _.
    
Definition DTONTokenWalletInternal_ι_decimals__left (x: ULValue DTONTokenWalletInternalLRecord): ULValue XInteger8 :=
    {{ {x} ^^ {DTONTokenWalletInternal_ι_decimals_} }} : _.
...
Definition DTONTokenWalletInternal_ι_balance__right {b} (x: URValueDTONTokenWalletInternalLRecord b): URValue XInteger128 b :=
    || {x} ^^ {DTONTokenWalletInternal_ι_balance_} || : _.
    
Definition DTONTokenWalletInternal_ι_balance__left (x: ULValue DTONTokenWalletInternalLRecord): ULValue XInteger128 :=
    {{ {x} ^^ {DTONTokenWalletInternal_ι_balance_} }} : _.
...
Definition DTONTokenWalletInternal_ι_root_public_key__right {b} (x: URValueDTONTokenWalletInternalLRecord b): URValue XInteger256 b :=
    || {x} ^^ {DTONTokenWalletInternal_ι_root_public_key_} || : _.
    
Definition DTONTokenWalletInternal_ι_root_public_key__left (x: ULValue DTONTokenWalletInternalLRecord): ULValue XInteger256 :=
    {{ {x} ^^ {DTONTokenWalletInternal_ι_root_public_key_} }} : _.
...
Definition DTONTokenWalletInternal_ι_wallet_public_key__right {b} (x: URValueDTONTokenWalletInternalLRecord b): URValue XInteger256 b :=
    || {x} ^^ {DTONTokenWalletInternal_ι_wallet_public_key_} || : _.
    
Definition DTONTokenWalletInternal_ι_wallet_public_key__left (x: ULValue DTONTokenWalletInternalLRecord): ULValue XInteger256 :=
    {{ {x} ^^ {DTONTokenWalletInternal_ι_wallet_public_key_} }} : _.
...
Definition DTONTokenWalletInternal_ι_workchain_id__right {b} (x: URValueDTONTokenWalletInternalLRecord b): URValue XInteger8 b :=
    || {x} ^^ {DTONTokenWalletInternal_ι_workchain_id_} || : _.
    
Definition DTONTokenWalletInternal_ι_workchain_id__left (x: ULValue DTONTokenWalletInternalLRecord): ULValue XInteger8 :=
    {{ {x} ^^ {DTONTokenWalletInternal_ι_workchain_id_} }} : _.
...
Definition DRootTokenContract_ι_decimals__right {b} (x: URValue DRootTokenContractLRecord b): URValue XInteger8 b :=
    || {x} ^^ {DRootTokenContract_ι_decimals_} || : _.
    
Definition DRootTokenContract_ι_decimals__left (x: ULValue DRootTokenContractLRecord): ULValue XInteger8 :=
    {{ {x} ^^ {DRootTokenContract_ι_decimals_} }} : _.
...
Definition DRootTokenContract_ι_root_public_key__right {b} (x: URValue DRootTokenContractLRecord b): URValue XInteger256 b :=
    || {x} ^^ {DRootTokenContract_ι_root_public_key_} || : _.
    
Definition DRootTokenContract_ι_root_public_key__left (x: ULValue DRootTokenContractLRecord): ULValue XInteger256 :=
    {{ {x} ^^ {DRootTokenContract_ι_root_public_key_} }} : _.
...
Definition DRootTokenContract_ι_total_supply__right {b} (x: URValue DRootTokenContractLRecord b): URValue XInteger128 b :=
    || {x} ^^ {DRootTokenContract_ι_total_supply_} || : _.
    
Definition DRootTokenContract_ι_total_supply__left (x: ULValue DRootTokenContractLRecord): ULValue XInteger128 :=
    {{ {x} ^^ {DRootTokenContract_ι_total_supply_} }} : _.
...
Definition DRootTokenContract_ι_total_granted__right {b} (x: URValue DRootTokenContractLRecord b): URValue XInteger128 b :=
    || {x} ^^ {DRootTokenContract_ι_total_granted_} || : _.
    
Definition DRootTokenContract_ι_total_granted__left (x: ULValue DRootTokenContractLRecord): ULValue XInteger128 :=
    {{ {x} ^^ {DRootTokenContract_ι_total_granted_} }} : _.
...
Notation " a '↑' 'DRootTokenContract.owner_address_' " := ( DRootTokenContract_ι_owner_address__right a ) (in custom URValue at level 0) : ursus_scope.
Notation " a '↑' 'DRootTokenContract.owner_address_' " := ( DRootTokenContract_ι_owner_address__left a ) (in custom ULValue at level 0) : ursus_scope.

Definition DRootTokenContract_ι_start_balance__right {b} (x: URValue DRootTokenContractLRecord b): URValue GramsLRecord b :=
    || {x} ^^ {DRootTokenContract_ι_start_balance_} || : _.
    
Definition DRootTokenContract_ι_start_balance__left (x: ULValue DRootTokenContractLRecord): ULValue GramsLRecord :=
    {{ {x} ^^ {DRootTokenContract_ι_start_balance_} }} : _.
...
Definition DTONTokenWallet_ι_decimals__right {b} (x: URValue DTONTokenWalletLRecord b): URValue XInteger8 b :=
    || {x} ^^ {DTONTokenWallet_ι_decimals_} || : _.
    
Definition DTONTokenWallet_ι_decimals__left (x: ULValue DTONTokenWalletLRecord): ULValue XInteger8 :=
    {{ {x} ^^ {DTONTokenWallet_ι_decimals_} }} : _.
...
Definition DTONTokenWallet_ι_balance__right {b} (x: URValue DTONTokenWalletLRecord b): URValue XInteger128 b :=
    || {x} ^^ {DTONTokenWallet_ι_balance_} || : _.
    
Definition DTONTokenWallet_ι_balance__left (x: ULValue DTONTokenWalletLRecord): ULValue XInteger128 :=
    {{ {x} ^^ {DTONTokenWallet_ι_balance_} }} : _.
...
Definition DTONTokenWallet_ι_root_public_key__right {b} (x: URValue DTONTokenWalletLRecord b): URValue XInteger256 b :=
    || {x} ^^ {DTONTokenWallet_ι_root_public_key_} || : _.
    
Definition DTONTokenWallet_ι_root_public_key__left (x: ULValue DTONTokenWalletLRecord): ULValue XInteger256 :=
    {{ {x} ^^ {DTONTokenWallet_ι_root_public_key_} }} : _.
...
Definition DTONTokenWallet_ι_wallet_public_key__right {b} (x: URValue DTONTokenWalletLRecord b): URValue XInteger256 b :=
    || {x} ^^ {DTONTokenWallet_ι_wallet_public_key_} || : _.
    
Definition DTONTokenWallet_ι_wallet_public_key__left (x: ULValue DTONTokenWalletLRecord): ULValue XInteger256 :=
    {{ {x} ^^ {DTONTokenWallet_ι_wallet_public_key_} }} : _.
...
Definition DTONTokenWallet_ι_workchain_id__right {b} (x: URValue DTONTokenWalletLRecord b): URValue XInteger8 b :=
    || {x} ^^ {DTONTokenWallet_ι_workchain_id_} || : _.
    
Definition DTONTokenWallet_ι_workchain_id__left (x: ULValue DTONTokenWalletLRecord): ULValue XInteger8 :=
    {{ {x} ^^ {DTONTokenWallet_ι_workchain_id_} }} : _.
