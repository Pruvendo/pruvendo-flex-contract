...
Notation " 'allowance_info.spender' " := ( allowance_info_ι_spender ) (in custom ULValue at level 0) : ursus_scope. 
 ...
 Definition balance__left := ( ULState (f:=_Contract) (H:=ContractLEmbeddedType balance_ ) : ULValue XInteger128 ) . 
 Definition balance__right := ( URState (f:=_Contract) (H:=ContractLEmbeddedType balance_ ) : URValue XInteger128 false ) . 
 ...
 Definition wallet_public_key__left := ( ULState (f:=_Contract) (H:=ContractLEmbeddedType wallet_public_key_ ) : ULValue XInteger256 ) . 
 Definition wallet_public_key__right := ( URState (f:=_Contract) (H:=ContractLEmbeddedType wallet_public_key_ ) : URValue XInteger256 false ) . 
