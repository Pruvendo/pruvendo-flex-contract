...
Definition optional_owner_right { a1 }  ( owner : URValue ( XAddress ) a1 ) : URValue (XMaybe XAddress) a1 := 
 ...
 Definition check_internal_owner : UExpression PhantomType true . 
 	 	 ...
 	 	 refine {{ require_ ( ( (_owner_address_ -> get_default () == int_sender ()) ) , 1 (* error_code::message_sender_is_not_my_owner *) ) }} . 
 Defined . 
 ...
 Definition check_external_owner ( allow_pubkey_owner_in_internal_node : ( XBool ) ) : UExpression PhantomType true . 
 	 	 ...
 	 	 refine {{ require_ ( ( (msg.pubkey ()) == _root_public_key_ ) , 1 (* error_code::message_sender_is_not_my_owner *) ) }} . 
 Defined . 
 ...
 Definition check_owner ( allow_pubkey_owner_in_internal_node : XBool ) : UExpression PhantomType false . 
 	 	 	 refine {{ if ( Internal ) then { _:EUf } else { _:EUf } ; { _ } }} . 
