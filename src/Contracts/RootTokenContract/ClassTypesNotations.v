...
Notation " a '↑' 'xxx' " := ( DRootTokenContract_ι_name__right a ) (in custom URValue at level 0) : ursus_scope.
Notation " a '↑' 'xxx' " := ( DRootTokenContract_ι_name__left a ) (in custom ULValue at level 0) : ursus_scope.
