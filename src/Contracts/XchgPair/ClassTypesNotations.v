...
Definition DXchgPair_ι_flex_addr__left (x: ULValue DXchgPairLRecord): ULValue address :=
    {{ {x} ^^ {DXchgPair_ι_flex_addr_} }} : _.
...
Definition DXchgPair_ι_tip3_major_root__right {b} (x: URValue DXchgPairLRecord b): URValue address b :=
    || {x} ^^ {DXchgPair_ι_tip3_major_root_} || : _ .
    
Definition DXchgPair_ι_tip3_major_root__left (x: ULValue DXchgPairLRecord): ULValue address :=
    {{ {x} ^^ {DXchgPair_ι_tip3_major_root_} }} : _.
...
Definition DXchgPair_ι_tip3_minor_root__right {b} (x: URValue DXchgPairLRecord b): URValue address b :=
    || {x} ^^ {DXchgPair_ι_tip3_minor_root_} || : _ .
    
Definition DXchgPair_ι_tip3_minor_root__left (x: ULValue DXchgPairLRecord): ULValue address :=
    {{ {x} ^^ {DXchgPair_ι_tip3_minor_root_} }} : _.
...
Definition DXchgPair_ι_notify_addr__right {b} (x: URValue DXchgPairLRecord b): URValue address b :=
    || {x} ^^ {DXchgPair_ι_notify_addr_} || : _ .
    
Definition DXchgPair_ι_notify_addr__left (x: ULValue DXchgPairLRecord): ULValue address :=
    {{ {x} ^^ {DXchgPair_ι_notify_addr_} }} : _.
...
(*| IonDeploy : XUInteger128 -> XUInteger128 -> address -> PublicInterfaceP *)
Definition IonDeploy_right { a1 a2 a3 }  ( min_amount : URValue XUInteger128 a1 ) 
                                         ( deploy_value : URValue XUInteger128 a2 ) 
                                         ( notify_addr : URValue address a3 ) : URValue IXchgPair (orb a1 (orb a2 a3)).
...
Notation " 'XchgPair.deploy' ( x ) " := (_Icreate_right x) (in custom URValue at level 0 , x custom URValue at level 0 ) : ursus_scope .
