...
Definition price__left := ( ULState (f:=_Contract) (H:=ContractLEmbeddedType DPriceXchg_ι_price_ ) : ULValue RationalPriceLRecord ) . 
 ...
 Definition workchain_id__left := ( ULState (f:=_Contract) (H:=ContractLEmbeddedType DPriceXchg_ι_workchain_id_ ) : ULValue uint8 ) . 
 Definition workchain_id__right := ( URState (f:=_Contract) (H:=ContractLEmbeddedType DPriceXchg_ι_workchain_id_ ) : URValue uint8 false ) . 
