...
Parameter verify_tip3_addr : Tip3ConfigLRecord -> raw_address -> uint256 -> uint256 -> UExpression boolean false . 
Parameter expected_wallet_address : Tip3ConfigLRecord -> uint256 -> uint256 -> UExpression uint256 false . 
Parameter on_ord_fail :  uint -> raw_address (* ITONTokenWalletPtrLRecord *)  -> uint128  -> UExpression OrderRetLRecord false . 
