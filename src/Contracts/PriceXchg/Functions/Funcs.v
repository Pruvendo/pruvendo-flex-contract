...
Definition make_deal (sell : ULValue OrderInfoXchgLRecord) 
					 (buy : ULValue OrderInfoXchgLRecord) : UExpression ( boolean # (boolean # uint128) ) false . 
...
Definition extract_active_order 
			...
			( sell : boolean ):  UExpression ((optional ( uint # OrderInfoXchgLRecord )) # 
								 ((queue OrderInfoXchgLRecord) # uint128 )) true . 
...
Notation " 'process_queue_impl_' '(' tip3root_sell ',' tip3root_buy ',' notify_addr ',' price ',' deals_limit ',' tons_cfg ',' sell_idx ',' buy_idx ',' sells_amount ',' sells ',' buys_amount ',' buys ')' " := 
 ...
 , tip3root_buy custom URValue at level 0 , notify_addr custom URValue at level 0 
 , price custom URValue at level 0 , deals_limit custom URValue at level 0 
 , tons_cfg custom URValue at level 0 , sell_idx custom URValue at level 0 
 , buy_idx custom URValue at level 0 , sells_amount custom URValue at level 0 
 , sells custom URValue at level 0 , buys_amount custom URValue at level 0 
...
Definition onTip3LendOwnership ( answer_addr : raw_address ) 
							   ...
							   ( payload : TvmCell ) : UExpression OrderRetLRecord false . 
...
wrapURExpression (ursus_call_with_args (LedgerableWithArgs:= λ7 ) cancel_order_impl orders client_addr all_amount sell return_ownership process_queue incoming_val ) . 
 ...
 , client_addr custom URValue at level 0 , all_amount custom URValue at level 0 
 , sell custom URValue at level 0 , return_ownership custom URValue at level 0 
...
Definition cancelBuy : UExpression PhantomType false . 
	...
	refine {{ new ( 'buys:(XQueue OrderInfoXchgLRecord) , 'buys_amount:uint128 ) @ ( "buys" , "buys_amount" ) :=
